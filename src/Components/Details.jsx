            ...
            <div className="mx-auto w-4/5">
                <div className="rounded-3xl bg-[#fff8e3] ">
                    <div className="w-full h-svh rounded-t-3xl">
                        <img src={loadedItem.photo} className="w-full h-svh rounded-t-3xl" />
                    </div>
                    <div className="pacifico p-10 flex flex-col gap-5">
                        <p className="text-[#5b9004] text-4xl font-bold">{loadedItem.item_name}</p>
                        ...
                        <div className="flex justify-between">
                            <p className="rounded-lg py-3 px-6 bg-[#5b9004] text-[#fcbb02] flex gap-2 justify-center items-center"><IoMdPricetags/>Price: {loadedItem.price} BDT</p>
                            <p className="rounded-lg py-3 px-6 bg-[#5b9004] text-[#fcbb02] flex gap-2 justify-center items-center">Rating: {loadedItem.rating} <FaStar /></p>
                            <p className="rounded-lg py-3 px-6 bg-[#5b9004] text-[#fcbb02] flex gap-2 justify-center items-center"><MdOutlineDashboardCustomize /> Customizable: {loadedItem.customization}</p>
                        </div>
                        <div className="">
